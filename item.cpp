...
void Item::use(Character *pg, vector<Character*> *enemies) { cout << "sto usando item " << endl; }
...
void Weapon::use() { cout << "sto usando Weapon " << " infliggi " << damage << " danno" << endl; }
...
Chest::Chest(int c): Armor(c), Item() {}
Chest::~Chest() { cout << "Elimino CHEST ARMOR: " << endl; }
void Chest::save() { cout << "salvo CHEST " << endl; }

Boots::Boots(int a): Armor(a), Item() {}
Boots::~Boots() { cout << "Te buto via e scarpe " << endl; }
void Boots::save() { cout << "salvo BOOTS " << endl; }